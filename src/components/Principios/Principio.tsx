...
const Principio: React.FC<{ Principios: Principios }> = ({ Principios }) => {
    return (
        <div className="flex flex-col m-5 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:flex-row ease-in duration-300 lg:hover:scale-110 ">
            {Principios.imagen !== "/" ? (
