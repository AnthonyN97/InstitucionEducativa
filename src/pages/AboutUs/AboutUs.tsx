            ...
            <div className="basis-3/5">
                <div className="container flex-col mx-auto p-4 sm:p-6 md:p-8 text-justify">
                    ...
                    <p className="text-base leading-7 py-1">
                        ...
                        <br />
                        Para plasmar la ruta por la que queremos lograr nuestros objetivos cada estudiante contará con la AGENDA EDUCATIVA 2014.
                        <br />
                        Este instrumento reflejará el ANUARIO, EL CALENDARIO, LA ORGANIZACIÓN ESCOLAR y naturalmente la agenda diaria de los acontecimientos educativos que deben ocurrir.
                        <br />
